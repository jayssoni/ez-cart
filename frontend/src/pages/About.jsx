...
function About() {
  return (
    <div className='w-[99vw] min-h-[100vh] flex items-center justify-center flex-col bg-[#EFE9E4] gap-10 pt-20 px-8'>
      ...
      <div className='w-full flex flex-col items-center gap-6'>
        ...
        <div className='w-4/5 flex flex-col lg:flex-row justify-between gap-8 py-10'>
          <div className='lg:w-1/3 w-full bg-white rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.08)] p-8 text-[#0F0F0F] flex flex-col items-center gap-4'>
            <b className='text-2xl font-semibold text-[#9B8C80]'>Quality Assurance</b>
            <p className='text-base leading-relaxed text-[#6B655B] text-center'>
              We guarantee quality through strict checks, reliable sourcing, and a commitment to customer satisfaction always.
            </p>
          </div>
          <div className='lg:w-1/3 w-full bg-white rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.08)] p-8 text-[#0F0F0F] flex flex-col items-center gap-4'>
            <b className='text-2xl font-semibold text-[#9B8C80]'>Convenience</b>
            <p className='text-base leading-relaxed text-[#6B655B] text-center'>
              Shop easily with fast delivery, simple navigation, secure checkout, and everything you need in one place.
            </p>
          </div>
          <div className='lg:w-1/3 w-full bg-white rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.08)] p-8 text-[#0F0F0F] flex flex-col items-center gap-4'>
            <b className='text-2xl font-semibold text-[#9B8C80]'>Exceptional Customer Service</b>
            <p className='text-base leading-relaxed text-[#6B655B] text-center'>
